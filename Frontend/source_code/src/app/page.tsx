  ...
  return (
    <main>
      <section
        ...
        className="flex flex-col items-center justify-center gap-12 p-24 px-8 sm:gap-14 lg:m-auto lg:max-w-screen-xl lg:flex-row lg:gap-20 2xl:h-[calc(100vh-76px)] 2xl:max-w-screen-2xl"
      >
